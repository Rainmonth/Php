...
<head>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="../../assets/eventually/css/ie8.css"/><![endif]-->
    <!--[if lte IE 9]>
    <link rel="stylesheet" href="../../assets/eventually/css/ie9.css"/><![endif]-->
</head>
<body>
...
<footer id="footer">
    <ul class="icons">
        ...
        <li><a href="#" class="icon fa-weibo"><span class="label">Email</span></a></li>
        <li><a href="#" class="icon fa-envelope-o"><span class="label">Email</span></a></li>
    </ul>
    <ul class="copyright">
        <li>&copy; 荏苒追寻</li>
        <li>Credits: <a href="http://rainmonth.com">荏苒追寻</a></li>
    </ul>
</footer>
...
<script src="../../assets/eventually/js/main.js"></script>
