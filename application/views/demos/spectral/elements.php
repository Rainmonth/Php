...
<div id="page-wrapper">
    ...
    <!-- Header -->
    <header id="header">
        <h1><a href="../Navigation/navToWelcome">Spectral</a></h1>
        <nav id="nav">
            <ul>
                <li class="special">
...
<script src="../../../../assets/common/js/jquery.scrollex.min.js"></script>
<script src="../../../../assets/common/js/jquery.scrolly.min.js"></script>
